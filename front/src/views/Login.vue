...
const onSignUp = () => {
  const payload = {
    ...
    password1: signUpData.value.password1,
    password2: signUpData.value.password2
  };
  ...
  <div class="container" :class="{ 'right-panel-active': isSignUpActive }">
    <div class="form-container sign-up-container">
      <form @submit.prevent="onSignUp">
        ...
        <input type="password" v-model="signUpData.password1" placeholder="Password" />
        <input type="password" v-model="signUpData.password2" placeholder="Confirm Password" />
